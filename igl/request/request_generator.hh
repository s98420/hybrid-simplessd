...
class RequestGenerator : public IOGenerator {
 private:
  ...
  std::uniform_real_distribution<float> ratioGen;
  ...
  uint64_t migration_skipped_count;
  std::unordered_set<uint64_t> validLBA[2];
  std::unordered_map<uint64_t, BIL::BIO> pendingMigration;
