...
class IOContext : public RequestContext {
 public:
  ...
  IOContext(RequestFunction &f, CQEntryWrapper &r)
      : RequestContext(f, r), tier(Tier::TLC) {}
};
...
class MigrationContext : public RequestContext {
 public:
  uint64_t beginAt;
  MigrationRequest req;

  MigrationContext(RequestFunction &f, CQEntryWrapper &r)
      : RequestContext(f, r), beginAt(0) {}
};
...
class Namespace {
 ...
 private:
  ...
  void migrate(SQEntryWrapper &, RequestFunction &);
