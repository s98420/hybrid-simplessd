...
class Subsystem : public AbstractSubsystem {
 protected:
  ...
  void convertUnit(Namespace *, uint64_t, uint64_t, Tier, Request &);
  ...
  bool queryTierSpace(SQEntryWrapper &, RequestFunction &);
 ...
 public:
  ...
  void read(Namespace *, uint64_t, uint64_t, Tier, DMAFunction &, void *);
  void write(Namespace *, uint64_t, uint64_t, Tier, DMAFunction &, void *);
  void flush(Namespace *, Tier, DMAFunction &, void *);
  void trim(Namespace *, uint64_t, uint64_t, Tier, DMAFunction &, void *);
  void migrate(Namespace *, MigrationRequest &, DMAFunction &, void *);
