...
class Config : public BaseConfig {
 private:
  ...
  float slcFillingRatio;       //!< Default: fillingRatio
  float tlcFillingRatio;       //!< Default: fillingRatio
  float slcInvalidRatio;       //!< Default: invalidRatio
  float tlcInvalidRatio;       //!< Default: invalidRatio
  bool slcFillingRatioSet;
  bool tlcFillingRatioSet;
  bool slcInvalidRatioSet;
  bool tlcInvalidRatioSet;
  ...
  uint64_t migrationListLimit; //!< Default: 1024 logical sub-entries
